...
if __name__ == '__main__':
    ...
    test_cases4 = unittest.TestLoader().loadTestsFromNames(['for_loader.TestCase1.ab_test_print_b'])
    test_cases5 = unittest.TestLoader().discover(casedir, pattern="ui_lianjia*.py", top_level_dir=None) 
